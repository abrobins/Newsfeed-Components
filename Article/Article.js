...
function createArticle(title, date, firstP, secondP, thirdP) {
  ...
  articleDiv.appendChild(headingTitle);
  articleDiv.appendChild(dateTag);
  articleDiv.appendChild(parag1);
  articleDiv.appendChild(parag2);
  articleDiv.appendChild(parag3);
  ...
  parag1.textContent = firstP;
  parag2.textContent = secondP;
  parag3.textContent = thirdP;
